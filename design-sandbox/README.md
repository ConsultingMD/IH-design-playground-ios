...
3. To force file context, use **@** mentions: e.g. `@design-sandbox/app-visual-language.md`, `@design-sandbox/personas/OVERVIEW.md`.
...
- [ ] Skim `app-visual-language.md` and update anything that is still placeholder.
